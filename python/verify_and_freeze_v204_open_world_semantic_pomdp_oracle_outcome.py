...
from v204_open_world_semantic_pomdp_oracle import audit_oracle, evaluate_oracle
...
def main() -> None:
    ...
    audit_path = PROJECT_ROOT / "outputs/v204-open-world-semantic-pomdp-oracle/outcome-audit.json"
    outcome_path = PROJECT_ROOT / "configs/v204-open-world-semantic-pomdp-oracle-outcome-lock.json"
    results_path = PROJECT_ROOT / "docs/v204-open-world-semantic-pomdp-oracle-results.md"
    if audit_path.exists() or outcome_path.exists():
        raise RuntimeError("V204 outcome already frozen")
    ...
    checks = {
        ...
        "language_protected_model_API_training_authority_action_and_execution_remain_zero": all(
            access[key] == 0
            for key in (
                "language_record_read_count",
    ...
    outcome_audit = {
        "schema_version": "204-open-world-semantic-POMDP-oracle-outcome-audit",
        "experiment": lock["experiment"],
        "passed": passed,
        "scientific_oracle_passed": scientific_pass,
        "decision": "freeze_verified_V204_oracle_result" if passed else "freeze_failed_V204_verification",
        "checks": checks,
        "summary": rebuilt,
    }
    ...
    outcome: dict[str, Any] = {
        "schema_version": "204-open-world-semantic-POMDP-oracle-outcome-lock",
        "experiment": lock["experiment"],
        "outcome": {
            "passed": True,
            "scientific_oracle_passed": scientific_pass,
        ...
        "authorization": {
            "preregister_separate_fresh_source_design_only": scientific_pass,
