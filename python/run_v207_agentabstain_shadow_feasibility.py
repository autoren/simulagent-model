...
def main() -> None:
    ...
    result = {
        "schema_version": "207-agentabstain-shadow-metadata-schema-feasibility-result",
        ...
        "summary": summary,
        "authorization": {
            "preregister_separate_deterministic_text_extraction_only": bool(audit["passed"] and scientific_pass),
