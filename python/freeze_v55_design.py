...
def main():
    ...
    parser.add_argument(
        "--audit", default="outputs/v55-short-horizon-bayes-adaptive-planning/design-audit.json"
    )
    parser.add_argument("--output", default="configs/v55-design-lock.json")
    ...
    if output.exists():
        raise RuntimeError("V55 design already frozen")
    ...
    if (
        ...
        raise RuntimeError("V55 design audit is not intact and bound")
    config = json.loads(config_path.read_text())
    lock = {
        "schema_version": 55,
        "experiment": "v55_design_lock",
        ...
        "authorization": {
            "write_and_audit_exact_bayes_adaptive_planner": True,
            "construct_v55_planning_population": False,
