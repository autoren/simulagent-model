...
def main() -> None:
    ...
    audit_path = PROJECT_ROOT / "outputs/v205-terminally-proper-open-world-semantic-pomdp/outcome-audit.json"
    outcome_path = PROJECT_ROOT / "configs/v205-terminally-proper-open-world-semantic-pomdp-outcome-lock.json"
    results_path = PROJECT_ROOT / "docs/v205-terminally-proper-open-world-semantic-pomdp-results.md"
    if audit_path.exists() or outcome_path.exists():
        raise RuntimeError("V205 outcome already frozen")
    ...
    outcome_audit = {
        "schema_version": "205-terminally-proper-open-world-semantic-POMDP-outcome-audit",
        "experiment": lock["experiment"],
        "passed": passed,
        "scientific_oracle_passed": scientific_pass,
        "decision": "freeze_verified_V205_oracle_result" if passed else "freeze_failed_V205_verification",
        "checks": checks,
        "summary": rebuilt,
    }
    ...
    outcome: dict[str, Any] = {
        "schema_version": "205-terminally-proper-open-world-semantic-POMDP-outcome-lock",
        "experiment": lock["experiment"],
        "outcome": {
            "passed": True,
            "scientific_oracle_passed": scientific_pass,
        ...
        "authorization": {
            "preregister_separate_fresh_source_feasibility_design_only": scientific_pass,
