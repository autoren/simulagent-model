#!/usr/bin/env python3
"""Freeze the audited V59 evaluator and authorize one candidate run."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output", default="configs/v59-evaluation-implementation-lock.json"
    )
    ...
    if output.exists():
        raise RuntimeError("V59 evaluation implementation is already frozen")
    ...
    if (
        ...
        raise RuntimeError("V59 evaluation audit is not intact and bound")
    lock = {
        "schema_version": 59,
        "experiment": "v59_evaluation_implementation_lock",
        ...
        "authorization": {
            "run_one_v59_candidate_evaluation": True,
            "run_additional_v59_candidate_evaluation": False,
            "change_v59_evaluation_implementation": False,
