...
def main() -> None:
    ...
    result = {
        "schema_version": "204-open-world-semantic-POMDP-oracle-result",
        ...
        "summary": summary,
        "authorization": {
            "preregister_separate_fresh_source_design_only": bool(audit["access_gates_passed"] and scientific_pass),
